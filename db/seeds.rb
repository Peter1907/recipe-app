...
# Dish.create(food_id: 1, recipe_id: 1, quantity: 1)
# Dish.create(food_id: 2, recipe_id: 1, quantity: 1)
# Dish.create(food_id: 3, recipe_id: 1, quantity: 1)
# Dish.create(food_id: 4, recipe_id: 1, quantity: 1)
# Dish.create(food_id: 5, recipe_id: 1, quantity: 1)